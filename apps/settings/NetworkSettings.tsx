...
export const NetworkSettings: React.FC = () => {
    ...
    return (
        <div className="max-w-2xl">
            <h1 className="text-2xl md:text-3xl font-light mb-2 md:mb-3">Network</h1>
            <p className="text-sm text-white/60 mb-6 md:mb-8">View your network connection status and metrics.</p>
            ...
            <section className="mb-6 md:mb-8">
                <h2 className="text-base md:text-lg font-medium mb-3 md:mb-4 flex items-center gap-2">
                    <Icon name="lan" className="text-blue-400" />
                    Connection Details
                </h2>
                <div className="bg-black/20 rounded-xl p-3 md:p-4 space-y-2 md:space-y-3">
            ...
            {/* Offline Notice */}
            {!isOnline && (
                <div className="mt-6 md:mt-8 p-3 md:p-4 bg-red-500/10 border border-red-500/20 rounded-lg flex items-start gap-3">
