# Windows15 Development Environment Initialization Script (PowerShell)
# This script sets up the development environment for agent sessions

$ErrorActionPreference = "Stop"  # Exit on any error

# Configuration
$DEV_PORT = 5000  # Vite dev server port (from vite.config.ts)

Write-Host "🚀 Starting Windows15 development environment..." -ForegroundColor Cyan
